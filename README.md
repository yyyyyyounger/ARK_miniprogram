...
4 距離今天最近的假期
5 課程頁數據分批獲取
6 使用雲函數看門狗，課程頁過期半年的課則操作數據庫除去recentFollowIdArr。（思路：判斷當前時間戳，超過半年的課且為finish時，搜索user集合recentFollowIdArr裡仍有該courseId的用戶，對其刪除。
7 ARK公眾號


#### 2021-9-19
所有課程歸檔 已完成 - by Kelvin。
**BUG** 點擊推送的訂閱卡片跳轉，會來不及更新緩存信息，如需強制重新登錄，但跳轉後的畫面仍是登錄態
**提上日程**：
1 邀請曾開過ARK的講者，復原歷史ARK
**Additional**
...
#### 2021-9-28
已算作穩定運行正式版，用戶數量已有111個。但宣傳還未到位，並未覆蓋全FST同學。
開始培養CS同學，寒假準備ARK公眾號。
**BUG** 點擊推送的訂閱卡片跳轉，會來不及更新緩存信息，如需強制重新登錄，但跳轉後的畫面仍是登錄態
**提上日程**：
1 ARK公眾號
...
6 使用雲函數看門狗，課程頁過期半年的課則操作數據庫除去recentFollowIdArr。（思路：判斷當前時間戳，超過半年的課且為finish時，搜索user集合recentFollowIdArr裡仍有該courseId的用戶，對其刪除。
7 ARK公眾號
3 ARK 2.0 精簡頁面佈局，將有效信息放到主頁，Tab Bar改為3個，個人信息隱藏到個人信息頁

...
var courseInfo_empty = [
    { id:0, name:"分享编號", shortName:"courseId",       input:"None",                    canEdit:false,     display:true },  // 雲端給該課程分配的編號
  ...
    { id:8, name:"助手",     shortName:"helperName",     input:"None",                    canEdit:true,      display:true },   // 同上
    { id:9, name:"助手id",   shortName:"helperid",       input:"None",                    canEdit:false,     display:false },
    { id:10, name:"追蹤人數", shortName:"followers",     input:"None",                    canEdit:false,     display:true },    // 該分享受追蹤的人數
    { id:11, name:"課程狀態", shortName:"courseState",   input:"None",                    canEdit:true,      display:true },    // 可設定為 "預備中", "講課中", "已結束"

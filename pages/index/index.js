...
Page({
  data: {
    ...
    QandAlist:[
    {
      ...
      answer: 'ARK小程式現作為FST ARK活動運作平台(可查看頂部協議)，也在開發其他契合澳大生活的功能，爭取成為普及全澳大的效率工具~'
    },
    {
      id:8,
      question: 'Q0.1:這個小程序能做什麼？',
      answer: '知識不只存在於書上，只要遵守ARK協議，你可以在這裡分享任何你認為有價值的東西，也可以從其他同學那裡獲取相對應的資源！不久的未來將提供一系列的澳大校園應用，敬請期待~'
    },
    {
      id:0,
    ...
    },
    {
      id:3,
      question: 'Q4:如何收到通知',
      answer: 'Follow的分享臨近時，我們將通過微信 - “服務通知”提醒您。同意接受訂閱並勾選不再詢問可大大提升使用體驗！如選擇取消訂閱，可前往更多頁“權限設置”修改訂閱權限。ps：無奈小程序的訂閱邏輯，只能採用這種獲取權限方式，只會在follow的課程開始前半小時才會推送！'
    },
    {
      id:4,
      question: 'Q5:如何開課',
